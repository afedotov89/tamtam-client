...
from tamtam_client.bots_api import BotsApi  # noqa: E501
...
class TestBotsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = tamtam_client.bots_api.BotsApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_edit_my_info(self):
        """Test case for edit_my_info
