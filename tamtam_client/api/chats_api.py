...
class ChatsApi(object):
    ...
    def add_members(self, body, chat_id, **kwargs):  # noqa: E501
        """Add members  # noqa: E501

        Adds members to chat. Additional permissions may require.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_members(body, chat_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param UserIdsList body: (required)
        ...
        if kwargs.get('async_req'):
            return self.add_members_with_http_info(body, chat_id, **kwargs)  # noqa: E501
        else:
            (data) = self.add_members_with_http_info(body, chat_id, **kwargs)  # noqa: E501
            return data

    def add_members_with_http_info(self, body, chat_id, **kwargs):  # noqa: E501
        """Add members  # noqa: E501

        Adds members to chat. Additional permissions may require.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_members_with_http_info(body, chat_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `add_members`")  # noqa: E501
    ...
    def edit_chat(self, body, chat_id, **kwargs):  # noqa: E501
        """Edit chat info  # noqa: E501

        Edits chat info: title, icon, etc…  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.edit_chat(body, chat_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ChatPatch body: (required)
        :param int chat_id: Chat identifier (required)
        :return: Chat
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.edit_chat_with_http_info(body, chat_id, **kwargs)  # noqa: E501
        else:
            (data) = self.edit_chat_with_http_info(body, chat_id, **kwargs)  # noqa: E501
            return data

    def edit_chat_with_http_info(self, body, chat_id, **kwargs):  # noqa: E501
        """Edit chat info  # noqa: E501

        Edits chat info: title, icon, etc…  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.edit_chat_with_http_info(body, chat_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `edit_chat`")  # noqa: E501
        # verify the required parameter 'chat_id' is set
        if ('chat_id' not in params or
                params['chat_id'] is None):
    ...
    def get_chats(self, **kwargs):  # noqa: E501
        ...
        :param Bigint marker: Points to next data page. `null` for the first page
        :return: ChatList
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_members_with_http_info(self, chat_id, **kwargs):  # noqa: E501
        ...
        if 'user_ids' in params:
            ...
            collection_formats['user_ids'] = ''  # noqa: E501
        if 'marker' in params:
            query_params.append(('marker', params['marker']))  # noqa: E501
        if 'count' in params:
            query_params.append(('count', params['count']))  # noqa: E501
    ...
    def send_action(self, body, chat_id, **kwargs):  # noqa: E501
        """Send action  # noqa: E501

        Send bot action to chat  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.send_action(body, chat_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ActionRequestBody body: (required)
        :param int chat_id: Chat identifier (required)
        :return: SimpleQueryResult
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.send_action_with_http_info(body, chat_id, **kwargs)  # noqa: E501
        else:
            (data) = self.send_action_with_http_info(body, chat_id, **kwargs)  # noqa: E501
            return data

    def send_action_with_http_info(self, body, chat_id, **kwargs):  # noqa: E501
        """Send action  # noqa: E501

        Send bot action to chat  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.send_action_with_http_info(body, chat_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `send_action`")  # noqa: E501
        # verify the required parameter 'chat_id' is set
        if ('chat_id' not in params or
                params['chat_id'] is None):
