...
class AttachmentRequest(object):
    ...
    discriminator_value_class_map = {
        'ContactAttachmentRequest': 'ContactAttachmentRequest',
'PhotoAttachmentRequest': 'PhotoAttachmentRequest',
'FileAttachmentRequest': 'FileAttachmentRequest',
'AudioAttachmentRequest': 'AudioAttachmentRequest',
'InlineKeyboardAttachmentRequest': 'InlineKeyboardAttachmentRequest',
'LocationAttachmentRequest': 'LocationAttachmentRequest',
'VideoAttachmentRequest': 'VideoAttachmentRequest',
'StickerAttachmentRequest': 'StickerAttachmentRequest'    }
