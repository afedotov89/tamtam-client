...
import six
from swagger_client.models.photo_token import PhotoToken  # noqa: F401,E501
...
class PhotoAttachmentRequestPayload(object):
    ...
    def __init__(self, url=None, token=None, photos=None):  # noqa: E501
        """PhotoAttachmentRequestPayload - a model defined in Swagger"""  # noqa: E501
        self._url = None
        self._token = None
        self._photos = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PhotoAttachmentRequestPayload, dict):
