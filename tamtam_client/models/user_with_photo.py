...
import six
from tamtam_client.models.user import User  # noqa: F401,E501
...
class UserWithPhoto(User):
    ...
    def __init__(self, avatar_url=None, full_avatar_url=None):  # noqa: E501
        """UserWithPhoto - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserWithPhoto, dict):
