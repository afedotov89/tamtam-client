...
class ContactAttachmentPayload(object):
    ...
    def __init__(self, vcf_info=None, tam_info=None):  # noqa: E501
        """ContactAttachmentPayload - a model defined in Swagger"""  # noqa: E501
        self._vcf_info = None
        self._tam_info = None
    ...
    def vcf_info(self, vcf_info):
        ...
        """
        if vcf_info is None:
            raise ValueError("Invalid value for `vcf_info`, must not be `None`")  # noqa: E501

        self._vcf_info = vcf_info

    @property
    def tam_info(self):
        """Gets the tam_info of this ContactAttachmentPayload.  # noqa: E501

        User info  # noqa: E501

        :return: The tam_info of this ContactAttachmentPayload.  # noqa: E501
        :rtype: Object
        """
        return self._tam_info

    @tam_info.setter
    def tam_info(self, tam_info):
        """Sets the tam_info of this ContactAttachmentPayload.

        User info  # noqa: E501

        :param tam_info: The tam_info of this ContactAttachmentPayload.  # noqa: E501
        :type: Object
        """
        if tam_info is None:
            raise ValueError("Invalid value for `tam_info`, must not be `None`")  # noqa: E501

        self._tam_info = tam_info
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ContactAttachmentPayload, dict):
