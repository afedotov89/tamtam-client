...
import six
from swagger_client.models.button import Button  # noqa: F401,E501
...
class CallbackButton(Button):
    ...
    def __init__(self, payload=None, intent=None):  # noqa: E501
        """CallbackButton - a model defined in Swagger"""  # noqa: E501
        self._payload = None
        self._intent = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CallbackButton, dict):
