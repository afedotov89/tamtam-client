...
class Message(object):
    ...
    def __init__(self, sender=None, recipient=None, timestamp=None, link=None, body=None, stat=None):  # noqa: E501
    ...
    def sender(self):
        ...
        User that sent this message. Can be `null` if message has been posted on behalf of a channel  # noqa: E501
