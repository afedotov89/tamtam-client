...
class ContactAttachmentRequestPayload(object):
    ...
    def __init__(self, name=None, contact_id=None, vcf_info=None, vcf_phone=None):  # noqa: E501
        """ContactAttachmentRequestPayload - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    def vcf_phone(self, vcf_phone):
        ...
        :type: str
        """
        if vcf_phone is None:
            raise ValueError("Invalid value for `vcf_phone`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ContactAttachmentRequestPayload, dict):
