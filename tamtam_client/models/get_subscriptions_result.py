...
import six
from swagger_client.models.subscription import Subscription  # noqa: F401,E501
...
class GetSubscriptionsResult(object):
    ...
    def __init__(self, subscriptions=None):  # noqa: E501
        """GetSubscriptionsResult - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetSubscriptionsResult, dict):
