...
class UserRemovedFromChatUpdate(Update):
    ...
    def __init__(self, chat_id=None, user=None, admin_id=None):  # noqa: E501
        """UserRemovedFromChatUpdate - a model defined in Swagger"""  # noqa: E501
        self._chat_id = None
        self._user = None
        self._admin_id = None
    ...
    def admin_id(self):
        ...
        Administrator who removed user from chat  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserRemovedFromChatUpdate, dict):
