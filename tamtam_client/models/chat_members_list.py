...
import six
from swagger_client.models.chat_member import ChatMember  # noqa: F401,E501
...
class ChatMembersList(object):
    ...
    def __init__(self, members=None, marker=None):  # noqa: E501
        """ChatMembersList - a model defined in Swagger"""  # noqa: E501
        self._members = None
        self._marker = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ChatMembersList, dict):
