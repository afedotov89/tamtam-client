...
from swagger_client.models.update import Update  # noqa: F401,E501
...
class UserAddedToChatUpdate(Update):
    ...
    def __init__(self, chat_id=None, user=None, inviter_id=None):  # noqa: E501
        """UserAddedToChatUpdate - a model defined in Swagger"""  # noqa: E501
        self._chat_id = None
        self._user = None
    ...
    def inviter_id(self):
        ...
        User who added user to chat  # noqa: E501
    ...
    def inviter_id(self, inviter_id):
        ...
        if inviter_id is None:
            raise ValueError("Invalid value for `inviter_id`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserAddedToChatUpdate, dict):
