...
class BotsApi(object):
    ...
    def edit_my_info(self, body, **kwargs):  # noqa: E501
        ...
        >>> thread = api.edit_my_info(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param BotPatch body: (required)
        :return: BotInfo
        ...
        if kwargs.get('async_req'):
            return self.edit_my_info_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.edit_my_info_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def edit_my_info_with_http_info(self, body, **kwargs):  # noqa: E501
        """Edit current bot info  # noqa: E501

        Edits current bot info. Fill only the fields you want to update. All remaining fields will stay untouched  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.edit_my_info_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `edit_my_info`")  # noqa: E501
