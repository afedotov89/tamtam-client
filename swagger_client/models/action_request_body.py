...
import six
from swagger_client.models.sender_action import SenderAction  # noqa: F401,E501
...
class ActionRequestBody(object):
    ...
    def __init__(self, action=None):  # noqa: E501
        """ActionRequestBody - a model defined in Swagger"""  # noqa: E501
        self._action = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ActionRequestBody, dict):
