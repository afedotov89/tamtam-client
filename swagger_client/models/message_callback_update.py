...
class MessageCallbackUpdate(Update):
    ...
    def __init__(self, callback=None, message=None):  # noqa: E501
        """MessageCallbackUpdate - a model defined in Swagger"""  # noqa: E501
        self._callback = None
        self._message = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MessageCallbackUpdate, dict):
