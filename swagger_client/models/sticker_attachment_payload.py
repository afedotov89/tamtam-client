...
import six
from swagger_client.models.attachment_payload import AttachmentPayload  # noqa: F401,E501
...
class StickerAttachmentPayload(AttachmentPayload):
    ...
    def __init__(self, code=None):  # noqa: E501
        """StickerAttachmentPayload - a model defined in Swagger"""  # noqa: E501
        self._code = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StickerAttachmentPayload, dict):
