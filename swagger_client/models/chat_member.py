...
class ChatMember(UserWithPhoto):
    ...
    def __init__(self, last_access_time=None, is_owner=None, is_admin=None, join_time=None, permissions=None):  # noqa: E501
        """ChatMember - a model defined in Swagger"""  # noqa: E501
