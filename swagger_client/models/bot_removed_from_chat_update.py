...
class BotRemovedFromChatUpdate(Update):
    ...
    def __init__(self, chat_id=None, user=None):  # noqa: E501
        """BotRemovedFromChatUpdate - a model defined in Swagger"""  # noqa: E501
        self._chat_id = None
        self._user = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BotRemovedFromChatUpdate, dict):
